...
object EnglishStrings : Strings(
    ...
    map = mapOf(
        ...
        StringKey.scriptSettings to "Script settings",
        StringKey.noSettingsDeclared to "This script does not declare any settings.",
        StringKey.settingsSummary to "Configured settings",
        StringKey.settingsSummaryBody to "Edits apply instantly and are persisted per script. %1\$d setting(s) declared.",
        StringKey.resetToDefault to "Reset to default",
        StringKey.exportSettings to "Export",
        StringKey.exportSettingsBody to "Copy this JSON to back up or share the script settings.",
        StringKey.importSettings to "Import",
        StringKey.importSettingsBody to "Paste a JSON payload exported from another device.",
        StringKey.settingsReset to "Settings reset to defaults",
        StringKey.settingsImported to "Settings imported",
        StringKey.settingsImportFailed to "Import failed: invalid JSON or value",
        ...
        StringKey.chooseFile to "Choose file",
        StringKey.undo to "Undo",
        StringKey.redo to "Redo",
        StringKey.format to "Format",
        StringKey.downloadFile to "Download file",
        StringKey.downloadConfirm to "Download %1\$s to Downloads/RoCat?",
        StringKey.developerOptions to "Developer options",
        StringKey.webViewDebugging to "WebView remote debugging",
        StringKey.webViewDebuggingBody to "Inspect browser and headless pages with Chrome DevTools",
...
object IndonesianStrings : Strings(
    ...
    map = mapOf(
        ...
        StringKey.options to "Opsi",

        StringKey.scriptSettings to "Pengaturan skrip",
        StringKey.noSettingsDeclared to "Skrip ini tidak mendeklarasikan pengaturan apa pun.",
        StringKey.settingsSummary to "Pengaturan terkonfigurasi",
        StringKey.settingsSummaryBody to "Perubahan langsung berlaku dan disimpan per skrip. %1\$d pengaturan dideklarasikan.",
        StringKey.resetToDefault to "Kembalikan ke bawaan",
        StringKey.exportSettings to "Ekspor",
        StringKey.exportSettingsBody to "Salin JSON ini untuk mencadangkan atau berbagi pengaturan skrip.",
        StringKey.importSettings to "Impor",
        StringKey.importSettingsBody to "Tempel payload JSON yang diekspor dari perangkat lain.",
        StringKey.settingsReset to "Pengaturan dikembalikan ke nilai bawaan",
        StringKey.settingsImported to "Pengaturan berhasil diimpor",
        StringKey.settingsImportFailed to "Impor gagal: JSON atau nilai tidak valid",
        ...
        StringKey.appearance to "Tampilan",
        StringKey.themeSystem to "Sistem",
        StringKey.themeLight to "Terang",
        StringKey.themeDark to "Gelap",
        StringKey.paste to "Tempel",
        StringKey.chooseFile to "Pilih file",
        StringKey.undo to "Urungkan",
        StringKey.redo to "Ulangi",
        StringKey.format to "Rapikan",
        StringKey.downloadFile to "Unduh file",
        StringKey.downloadConfirm to "Unduh %1\$s ke Downloads/RoCat?",
        StringKey.developerOptions to "Opsi developer",
        StringKey.webViewDebugging to "Debugging jarak jauh WebView",
        StringKey.webViewDebuggingBody to "Inspeksi halaman browser dan headless dengan Chrome DevTools",
